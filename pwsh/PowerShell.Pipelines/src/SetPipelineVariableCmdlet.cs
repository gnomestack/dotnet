...
[Alias("set_pipeline_var")]
[OutputType(typeof(void))]
[Cmdlet(VerbsCommon.Set, "PipelineVariable")]
public class SetPipelineVariableCmdlet : PSCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        if (Util.IsTfBuild)
        {
            Console.WriteLine($"##vso[task.setvariable variable={this.Name};]{this.Value}");
            return;
        }
