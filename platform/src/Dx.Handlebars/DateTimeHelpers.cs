...
public static class DateTimeHelpers
{
    ...
    internal static void FormatDate(EncodedTextWriter writer, Context context, Arguments arguments)
    {
    ...
    internal static void Now(EncodedTextWriter writer, Context context, Arguments arguments)
    {
