    ...
    public static bool AsBool(this object? value, bool defaultValue)
    {
        ...
        if (value is string stringValue)
        {
            if (stringValue == "1" ||
                ...
                stringValue.IsEqualTo("yes") ||
                stringValue.IsEqualTo("y") ||
                stringValue.IsEqualTo("on"))
                return true;

            if (stringValue == "0" ||
                stringValue.IsEqualTo("false") ||
                stringValue.IsEqualTo("no") ||
                stringValue.IsEqualTo("n") ||
                stringValue.IsEqualTo("off"))
                return false;
